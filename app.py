...
st.set_page_config(
    page_title="Career Mentor AI Platform",
    page_icon="🚀",
    layout="wide"
)
...
class ResumeApp:
    ...
    def render_about(self):
        ...
        st.markdown("""
            <div class="hero-section">
                <h1 class="hero-title">About Career Mentor AI Platform</h1>
        ...
        st.markdown(f"""
            <div class="profile-section">
                <img src="{image_base64 if image_base64 else 'Smart-AI-Resume-Analyzer-main/assets/photo.jpg'}" 
                    class="profile-image"
                    onerror="this.onerror=null; this.src='Smart-AI-Resume-Analyzer-main/assets/photo.jpg';">
                <h2 class="profile-name">Kinjal Gauswami</h2>
                <p class="profile-title">Data Science & Data Analytics</p>
                <div class="social-links">
                    <a href="https://github.com/Kinjal0706/" class="social-link" target="_blank">
                        <i class="fab fa-github"></i>
                    </a>
                    <a href="https://www.linkedin.com/in/kinjalgauswami/" class="social-link" target="_blank">
                        <i class="fab fa-linkedin"></i>
                    </a>
                    <a href="mailto:kinjugoaswami@gmail.com" class="social-link" target="_blank">
                        <i class="fas fa-envelope"></i>
                    </a>
                </div>
                <p class="bio-text">
                    Hello! I'm a passionate Data Analyst with expertise in Data Science and AI.
                    I created the Career Mentor AI Platform to revolutionize how job seekers navigate their career paths.
                    With my strong background in data analysis, statistical modeling, and machine learning,
                    I've designed this platform to provide intelligent, data-driven insights for personalized job and skill recommendations.
                </p>
            </div>
        """, unsafe_allow_html=True)
        ...
        st.markdown("""
            <div class="vision-section">
                ...
                <p class="vision-text">
                    "Career Mentor AI Platform represents my vision of democratizing career advancement through technology. 
    ...
    def render_feedback_page(self):
        ...
        st.markdown("""
            <div class="feedback-header">
                ...
                <p>Help us improve Career Mentor AI Platform with your valuable feedback</p>
            </div>
        """, unsafe_allow_html=True)
  ...
  #  Sidebar with login and navigation
        with st.sidebar:
            ...
            st.title("Career Mentor AI Platform")
            st.markdown("---")
        ...
        #  Default home page on first load
        ...
        page_mapping = {
            name.lower().replace(" ", "_").replace("🏠", "").replace("🔍", "").replace("📝", "").strip(): name
